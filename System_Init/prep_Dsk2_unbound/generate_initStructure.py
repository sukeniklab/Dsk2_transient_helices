...
pdb_file = "AF-P48510-F1-model_v4.pdb" 
chain_id = "A"            
numTrials = 10
...
with open("Dsk2_full-seq.txt" , "w") as f:
...
# with open("mTur_F%i_GS%i_DD%i_mNeonGreen-domain.txt" %(sticker_id, linker_length, dk_space), "w") as f:
#     f.write("%i %i" %(1, residue_id))

#     f.write("\n")
#     f.write("%i %i" %(start_nGreen+1, len(newSequence)))
